...
class SanctionedPersonChecker(
    ...
    fun check(fullName: String, dob: LocalDate? = null): List<SanctionedPersonCheck> {
        val topCandidates = sanctionedCandidateFetcher.fetchTopCandidates(fullName, dob, 20)
